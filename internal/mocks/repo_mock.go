...
// Source: consumer-producer/internal/app/repo (interfaces: EventRepo)

// Package mocks is a generated GoMock package.
package mocks

import (
	model "consumer-producer/internal/model"
	reflect "reflect"
...
func (m *MockEventRepo) Add(arg0 []model.EntityEvent) error {
	m.ctrl.T.Helper()
...
func (m *MockEventRepo) Lock(arg0 uint64) ([]model.EntityEvent, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Lock", arg0)
	ret0, _ := ret[0].([]model.EntityEvent)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
